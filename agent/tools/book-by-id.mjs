// Usage: node book-by-id.mjs <pendingJobId> <at ISO date> <via> '<detail>' [status]
//   status defaults to 'applied'; use 'manual_done' for ones the user submitted herself.
...
const [id, at, via, detail, status = 'applied'] = process.argv.slice(2);
