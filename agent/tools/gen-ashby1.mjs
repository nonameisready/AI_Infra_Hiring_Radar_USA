...
var fills=[[/^name$|full name/i,'Hui Mao'],[/preferred (first )?name|preferred name|nickname|goes by|what should we call/i,'Belinda'],[/^first name|given name/i,'Hui'],[/^last name|surname|family name/i,'Mao'],[/^email/i,'huiluckylucky@gmail.com'],[/^phone|mobile phone/i,'2812507589'],[/linkedin/i,'https://www.linkedin.com/in/belindamao'],[/github|portfolio|^website/i,'https://github.com/nonameisready'],[/most recent company|current company|current employer/i,'Bank of America (via Innova Solutions)'],[/zip code/i,'07306'],[/compensation|salary/i,'$150,000+ base (negotiable)'],[/current job title|current title/i,'Senior Software Engineer'],[/years of experience/i,'7'],[/^city|city of residence/i,'New York'],[/^state$|^state |state of residence|state.province/i,'New Jersey']];
